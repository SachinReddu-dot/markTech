        ...
        <section id="services" className="py-16 text-center">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-black p-6 rounded-lg shadow-lg">
                    ...
                    <p className="text-gray-600 mb-4">We create modern, responsive websites to meet your business needs.</p>
                    <a href="#" className="text-blue-600 hover:underline">Learn More</a>
                </div>
                {/* <!-- Service Card 2 --> */}
                <div className="bg-black p-6 rounded-lg shadow-lg">
                    <h3 className="text-xl sm:text-2xl font-semibold mb-4">App Development</h3>
                    <p className="text-gray-600 mb-4">Our team builds powerful mobile applications for both iOS and Android.</p>
                    <a href="#" className="text-blue-600 hover:underline">Learn More</a>
                </div>
                {/* <!-- Service Card 3 --> */}
                <div className="bg-black p-6 rounded-lg shadow-lg">
                    <h3 className="text-xl sm:text-2xl font-semibold mb-4">SEO Optimization</h3>
                    <p className="text-gray-600 mb-4">We optimize your website to rank higher in search engine results.</p>
                    <a href="#" className="text-blue-600 hover:underline">Learn More</a>
                </div>
            </div>
        </section>
